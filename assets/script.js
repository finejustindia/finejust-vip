...
(function() {
  ...
  window.FINEJUST_TOOLS = window.FINEJUST_TOOLS || [
    { id: "percentage-calculator", title: "Percentage Calculator", description: "Calculate percentages, percentage increase/decrease, retail markdowns, and fractions instantly.", category: "Calculators", categorySlug: "calculators", url: "tools/percentage-calculator.html", icon: "percent", keywords: ["percentage", "math", "discount", "increase", "decrease", "fraction", "ratio"], featured: true, trending: true, popular: true },
    { id: "age-calculator", title: "Age Calculator", description: "Calculate exact chronological age in years, months, days, hours, and countdown to your next birthday.", category: "Calculators", categorySlug: "calculators", url: "tools/age-calculator.html", icon: "calendar", keywords: ["age", "birthday", "date of birth", "dob", "chronological age"], featured: false, trending: true, popular: true },
    { id: "emi-calculator", title: "EMI Calculator", description: "Calculate monthly loan installments (EMI), total interest payable, and comprehensive amortization schedules.", category: "Finance", categorySlug: "finance", url: "tools/emi-calculator.html", icon: "credit-card", keywords: ["emi", "loan", "mortgage", "interest", "finance", "bank", "installment"], featured: true, trending: true, popular: true },
    { id: "bmi-calculator", title: "BMI Calculator", description: "Evaluate Body Mass Index using Metric or Imperial units and check WHO healthy weight categories.", category: "Calculators", categorySlug: "calculators", url: "tools/bmi-calculator.html", icon: "activity", keywords: ["bmi", "body mass index", "fitness", "health", "weight", "obesity", "diet"], featured: true, trending: true, popular: true },
    { id: "gst-calculator", title: "GST Calculator", description: "Compute inclusive and exclusive Goods and Services Tax with accurate CGST/SGST/IGST breakdowns.", category: "Finance", categorySlug: "finance", url: "tools/gst-calculator.html", icon: "receipt", keywords: ["gst", "tax", "vat", "sales tax", "cgst", "sgst", "invoice"], featured: true, trending: true, popular: true },
    ...
    { id: "loan-calculator", title: "Loan Calculator", description: "Estimate personal, auto, and mortgage amortizations with weekly, bi-weekly, or monthly frequencies.", category: "Finance", categorySlug: "finance", url: "tools/loan-calculator.html", icon: "dollar-sign", keywords: ["loan", "mortgage", "interest", "principal", "amortization"], featured: false, trending: false, popular: false },
    { id: "simple-interest-calculator", title: "Simple Interest Calculator", description: "Calculate fixed interest returns and maturity balance across days, months, or years.", category: "Finance", categorySlug: "finance", url: "tools/simple-interest-calculator.html", icon: "bar-chart", keywords: ["simple interest", "principal", "rate", "time", "yield"], featured: false, trending: false, popular: false },
    { id: "compound-interest-calculator", title: "Compound Interest Calculator", description: "Project long-term compound growth, annual percentage yield (APY), and recurring investment contributions.", category: "Finance", categorySlug: "finance", url: "tools/compound-interest-calculator.html", icon: "trending-up", keywords: ["compound interest", "investment", "wealth", "apy", "growth", "savings"], featured: true, trending: true, popular: true },
    { id: "currency-converter", title: "Currency Converter", description: "Convert across 25+ global currencies (USD, EUR, GBP, INR, JPY, CAD) with real-time reciprocal rates.", category: "Converters", categorySlug: "converters", url: "tools/currency-converter.html", icon: "globe", keywords: ["currency", "forex", "usd", "eur", "gbp", "inr", "exchange rate", "money"], featured: true, trending: true, popular: true },
    { id: "length-converter", title: "Length Converter", description: "Convert meters, kilometers, miles, yards, feet, inches, centimeters, and nautical miles.", category: "Converters", categorySlug: "converters", url: "tools/length-converter.html", icon: "maximize-2", keywords: ["length", "distance", "meters", "feet", "inches", "miles"], featured: false, trending: false, popular: false },
    { id: "weight-converter", title: "Weight Converter", description: "Convert between kilograms, grams, pounds, ounces, stones, metric tons, and carats.", category: "Converters", categorySlug: "converters", url: "tools/weight-converter.html", icon: "package", keywords: ["weight", "mass", "kg", "lbs", "grams", "ounces"], featured: false, trending: false, popular: false },
    { id: "temperature-converter", title: "Temperature Converter", description: "Convert temperatures between Celsius, Fahrenheit, Kelvin, and Rankine with instant formulas.", category: "Converters", categorySlug: "converters", url: "tools/temperature-converter.html", icon: "thermometer", keywords: ["temperature", "celsius", "fahrenheit", "kelvin"], featured: false, trending: false, popular: false },
    { id: "speed-converter", title: "Speed Converter", description: "Convert velocity between km/h, mph, m/s, knots, feet per second, and Mach.", category: "Converters", categorySlug: "converters", url: "tools/speed-converter.html", icon: "zap", keywords: ["speed", "velocity", "kmh", "mph", "knots", "mach"], featured: false, trending: false, popular: false },
    { id: "qr-code-generator", title: "QR Code Generator", description: "Generate high-resolution permanent QR codes for URLs, text, Wi-Fi networks, and contact cards with PNG download.", category: "Image Tools", categorySlug: "image-tools", url: "tools/qr-code-generator.html", icon: "grid", keywords: ["qr code", "qr generator", "barcode", "wifi qr", "png", "matrix"], featured: true, trending: true, popular: true },
    { id: "password-generator", title: "Password Generator", description: "Create strong, uncrackable cryptographic random passwords with live entropy bits and strength scoring.", category: "Web Tools", categorySlug: "web-tools", url: "tools/password-generator.html", icon: "lock", keywords: ["password generator", "security", "random password", "entropy", "crypto"], featured: true, trending: true, popular: true },
    { id: "word-counter", title: "Word Counter", description: "Count words, characters, sentences, paragraphs, reading/speaking time, and top keyword density in real time.", category: "Text Tools", categorySlug: "text-tools", url: "tools/word-counter.html", icon: "file-text", keywords: ["word count", "character count", "reading time", "essay", "seo", "density"], featured: true, trending: true, popular: true },
    { id: "character-counter", title: "Character Counter", description: "Track character limits, letters, digits, spaces, SMS segments, and Twitter/X post lengths in real time.", category: "Text Tools", categorySlug: "text-tools", url: "tools/character-counter.html", icon: "type", keywords: ["character counter", "letter counter", "twitter", "sms"], featured: false, trending: false, popular: false },
    { id: "case-converter", title: "Case Converter", description: "Transform text between UPPERCASE, lowercase, Title Case, camelCase, kebab-case, snake_case, and PascalCase.", category: "Text Tools", categorySlug: "text-tools", url: "tools/case-converter.html", icon: "edit-3", keywords: ["case converter", "uppercase", "camelcase", "snake_case"], featured: false, trending: false, popular: false },
    { id: "base64-encoder", title: "Base64 Encoder & Decoder", description: "Encode and decode plain text or binary data strings to and from Base64 with full UTF-8 Unicode support.", category: "Web Tools", categorySlug: "web-tools", url: "tools/base64-encoder.html", icon: "code", keywords: ["base64", "base64 encode", "base64 decode", "utf8", "binary"], featured: false, trending: false, popular: false }
  ];
  ...
  window.printCurrentTool = function() {
    try {
      ...
      let toolTitle = 'Calculation Report';
      if (toolH1 && toolH1.textContent) {
        toolTitle = toolH1.textContent.trim();
      } else if (document.title) {
        toolTitle = document.title.split('â€”')[0].split('-')[0].trim();
      }
      ...
      if (isQR) {
        // QR Code Generator Specific: Print ONLY the QR Code & Metadata
        ...
        // All Other Tools: Clone the live tool card directly from the webpage
        ...
        // Ensure result card in print document is visible with current state
        clonedNode.querySelectorAll('.result-card').forEach(rc => {
        ...
        for (let i = 0; i < origInputs.length; i++) {
          ...
          if (orig.tagName.toLowerCase() === 'select') {
            const selText = (orig.options && orig.selectedIndex >= 0 && orig.options[orig.selectedIndex]) ? (orig.options[orig.selectedIndex].text || orig.value) : orig.value;
            const valSpan = document.createElement('div');
            valSpan.className = 'print-input-val-badge';
            valSpan.textContent = selText;
            if (cl.parentNode) cl.parentNode.replaceChild(valSpan, cl);
      ...
      // Trigger Print safely with fallback
      setTimeout(function() {
        window.print();
      }, 50);
    } catch(err) {
